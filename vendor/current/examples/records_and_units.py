...
from ucsb_xrp import MotionCommand, MotorEfforts, Pose, WheelSpeeds


pose = Pose(250.0, -75.0, 0.5)
wheel_speeds = WheelSpeeds(120.0, 115.0)
command = MotionCommand(100.0, -0.25)
efforts = MotorEfforts(0.30, 0.28)
...
print("motor_efforts_normalized:", efforts.left, efforts.right)

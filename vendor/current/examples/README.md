...
| `no_motion_sensor_read.py` | XRP with XRPLib | Live encoders, button, and range with zero effort |

`no_motion_sensor_read.py` explicitly sends zero effort and calls `stop()` in

...
def run_component_checks(*component_classes, **components):
    ...
    the range-estimation portion of \`\`SensorProcessor\`\` as well.
    ...
    if include_range:
        ...
        if sensor_model is None:
            raise ValueError("include_range requires SensorProcessor")

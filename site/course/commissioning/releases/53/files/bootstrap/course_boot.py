...
its imports, hardware setup, program worker, network recovery, and event-loop
tasks are ready. Router availability does not determine runtime health. If
startup fails synchronously, or a reset occurs before confirmation,

...
project is stored in its own named Project folder inside the Working folder;
choosing a different parent folder does not move the project that is already
open. The browser checks firmware and required runtime versions, installs and

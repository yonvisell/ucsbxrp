...
Edge. Choose a workspace or defer it, connect the RP2350 XRP by USB-C, select it
...
workspace chooser; completing that chooser-to-Web-Serial path and granting

      ...
      <main className="overview-content">
        ...
        <section id="scope">
          ...
          <p>
            ...
            the virtual XRP or the physical RP2350 XRP. The browser applications
            edit and transfer projects, host the virtual target, display
            telemetry, and commission the physical robot. Robot behavior and
            course algorithms remain in Python; browser code does not implement
            navigation, odometry, mapping, or planning on behalf of student
            code.
          </p>
          ...
          <p>
            ...
            Ground truth is used for virtual evaluation and rendering; it is not
            substituted for student odometry.
          </p>
        </section>
        ...
        <section id="course">
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Measure wheel motion, regulate speed, and stop at a distance.
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  Visit ordered world-coordinate goals and finish at a heading.
                </td>
                <td>
          ...
          <p>
            ...
            supplied or student implementation of each component independently,
            permitting isolated testing and staged integration.
          </p>
        </section>
...
Measurements.wheel_speeds ------------+
          ...
          <p>
            ...
            absolute sample deadline, reads the target once, updates measurement
            and pose, computes the next drive command, and returns one{" "}
            <code>RobotState</code>. Motion programs place{" "}
...
Pose -----------------------------> NavigationController ------+
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Convert the active world-coordinate goal and current pose to a
                  command.
                </td>
                <td>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Task, student responsibilities, supplied parts, program flow,
              ...
              <tr>
                ...
                <td>
                  Student implementations with the public component interfaces.
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="apps">
          ...
          <dl>
            <dt>IDE</dt>
            <dd>
              Edits project files, validates MicroPython, runs component checks,
              transfers projects, starts and stops either target, and records
            ...
            <dd>
              ...
              course runtime, retain or replace network configuration, reset the
              robot, and verify the installed release.
            </dd>
        ...
        <section id="targets">
          ...
          <p>
            ...
            project transfer, control, and telemetry use Wi-Fi. The XRP may host
            its own access point or join a local 2.4 GHz network; the browser
            connects to the configured XRP address in either mode.
          </p>
        </section>
        ...
        <section id="data">
          ...
          <p>
            ...
            student-defined plot signal; neither requires students to implement
            transport code.
          </p>
          <p>
        ...
        <section id="release">
          ...
          <p>
            ...
            and release metadata. A production build generates content-addressed
            browser assets, a commissioning manifest with hashes, and an offline
            manifest.
          </p>
          <p>
